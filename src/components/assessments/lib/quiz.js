const questions = [
  ...
  },
  {
    ...
    answers: [
      {
        answerText: "(The basic) rights of people living in the United States",
        isCorrect: true,
      },
      {
        answerText: "(The basic) rights of people living in some states",
        isCorrect: false,
      },
      {
        answerText: "(The basic) rights of people US Citizens only",
        isCorrect: false,
      },
      {
        answerText: "(The basic) rights of US Citizens living abroad",
        isCorrect: false,
      },
    ],
  },
  ...
  },
  {
    ...
    answers: [
      {
        answerText: "It says the government is the ruling body.",
        isCorrect: false,
      },
      {
        answerText: "It says the President must only serve 3 years.",
        isCorrect: false,
      },
  ...
  },
  {
    ...
    answers: [
      {
        answerText: "the American dream & the Free Trade Agreement of 1796",
        isCorrect: false,
      },
      { answerText: "Equality & Limited government", isCorrect: true },
      {
        answerText: "the Free Trade Agreement of 1796 & Limited government",
        isCorrect: false,
      },
  ...
  },
  {
    ...
    answers: [
      ...
      {
        answerText: "the American Society Founding Document",
        isCorrect: false,
      },
      { answerText: "Declaration of Independence", isCorrect: true },
  ...
  },
  {
    ...
    answers: [
      {
        answerText: "Everyone must follow the law but only in public spaces.",
        isCorrect: false,
      },
      { answerText: "Some people are above the law.", isCorrect: false },
      {
        answerText: "Only the President may break the law during war time",
        isCorrect: false,
      },
  ...
  },
  {
    ...
    answers: [
      {
        answerText: "There are four (4) branches of government",
        isCorrect: false,
      },
      {
        answerText:
          "Because of the three (3) articles mentioned in the Constitution",
        isCorrect: false,
      },
      { answerText: "Separation of powers", isCorrect: true },
      {
        answerText:
          "Each one to represent the President, the Vice-President, and the Secretary of State",
        isCorrect: false,
      },
    ],
  },
  {
    ...
    answers: [
      {
        answerText: "President, police department, and family court",
        isCorrect: false,
      },
      { answerText: "Legislative, executive, and judicial", isCorrect: true },
      {
        answerText: "Executive, police department, and supreme Court",
        isCorrect: false,
      },
      {
        answerText: "Republican, democratic, and independent",
        isCorrect: false,
      },
    ],
  },
  ...
  },
  {
    ...
    answers: [
      ...
      {
        answerText: "The President and House (of Representatives)",
        isCorrect: false,
      },
  ...
  },
  {
    ...
    answers: [
      ...
      {
        answerText: "(Because of) the state's geographic size",
        isCorrect: false,
      },
    ],
  },
